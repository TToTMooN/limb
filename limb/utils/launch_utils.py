...
from limb.robots.robot import ROBOT_PROTOCOL_METHODS, Robot
from limb.utils.portal_utils import (
    Client,
    RemoteServer,
...
def setup_can_interfaces():
    ...
    subprocess.run(["bash", "limb/scripts/reset_all_can.sh"], check=True)
    time.sleep(0.5)
