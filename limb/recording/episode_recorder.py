    ...
    def record(self, obs: Observation, action: Dict[str, Any], *, intervention: bool = False) -> None:
        ...
        Args:
            ...
            intervention: ``True`` if this frame was generated by an operator
                correction (DAgger CORRECTING phase), ``False`` if by the
                autonomous policy.  Defaults to ``False`` so non-DAgger
                recording paths keep working unchanged.
        """
        with self._lock:
            ...
            self._interventions.append(bool(intervention))
